    ...
    switch (weapon)
    {
        ...
        case M4A1:
            return {
                ...
                { 0 * modifier, 0 * modifier, 0 * modifier, 18 * modifier, 21 * modifier, 24 * modifier, 14 * modifier, 12 * modifier, 5 * modifier, 10 * modifier, 5 * modifier, -3 * modifier, 0 * modifier, -3 * modifier, 3 * modifier, 3 * modifier, 1 * modifier, -2 * modifier, 2 * modifier, 1 * modifier },
